...
export const FORM_SCHEMAS: Record<string, FormSchema> = {
  ...
  'convite-evento': {
    ...
    has_approval_flow: false,
    has_downloadable_artifact: true,
    template_variant_field: '_variante_convite',
    fields: [
      ...
      { name: '_variante_convite', label: 'Variante (auto)', type: 'select',
        options: [
          { value: '1-stories', label: '1 palestrante(s) — Stories (1080×1920)' },
          { value: '1-feed', label: '1 palestrante(s) — Feed (1080×1350)' },
          { value: '1-quadrado', label: '1 palestrante(s) — Quadrado (600×400)' },
          { value: '2-stories', label: '2 palestrante(s) — Stories (1080×1920)' },
          { value: '2-feed', label: '2 palestrante(s) — Feed (1080×1350)' },
          { value: '2-quadrado', label: '2 palestrante(s) — Quadrado (600×400)' },
          { value: '3-stories', label: '3 palestrante(s) — Stories (1080×1920)' },
          { value: '3-feed', label: '3 palestrante(s) — Feed (1080×1350)' },
          { value: '3-quadrado', label: '3 palestrante(s) — Quadrado (600×400)' },
          { value: '4-stories', label: '4 palestrante(s) — Stories (1080×1920)' },
          { value: '4-feed', label: '4 palestrante(s) — Feed (1080×1350)' },
          { value: '4-quadrado', label: '4 palestrante(s) — Quadrado (600×400)' }
        ] },
