...
const STATUS_SOLICITACAO = [
  { id: "recebido",               label: "Recebido",                   bg: "#eef1f5", text: "#3f4c5f"  },
  { id: "alinhamentos",           label: "Alinhamentos",               bg: "#dbe9fe", text: "#1656c4"    },
  { id: "em-analise",             label: "Em análise",                 bg: "#fdedc0", text: "#8a5a00"      },
  { id: "em-andamento",           label: "Em andamento",               bg: "#fdedc0", text: "#8a5a00" },
  { id: "em-producao",            label: "Em produção",                bg: "#ffe4c7", text: "#b8460a"      },
  ...
  { id: "aguardando-finalizacao", label: "Aguardando finalização",     bg: "#e7ddff", text: "#6528d4" },
  { id: "concluido",              label: "Concluído",                  bg: "#c3f5d4", text: "#00814a"    },
  ...
  { id: "publicado",              label: "Concluído",                  bg: "#c3f5d4", text: "#00814a"    },
  // aprovado pelo RH, aguardando o marketing publicar (vem de assessor_publicacoes)
  { id: "aprovado",               label: "Aprovado",                   bg: "#dbe9fe", text: "#1656c4"    },
  // usados na validacao de assessores; ficam aqui para haver uma fonte unica dos status
  { id: "ajustes-solicitados",    label: "Ajustes solicitados",        bg: "#ffe4c7", text: "#b8460a"    },
  { id: "registrado",             label: "Registrado",                 bg: "#eef1f5", text: "#3f4c5f"    },
  { id: "cancelado",              label: "Cancelado",                  bg: "#ffdcdc", text: "#c62828"  },
  { id: "em-espera",              label: "Em espera",                  bg: "#eef1f5", text: "#3f4c5f"  },
  { id: "gerando",                label: "Gerando arte",               bg: "#dbe9fe", text: "#1656c4" },
  { id: "erro",                   label: "Erro",                       bg: "#ffdcdc", text: "#c62828" },
  { id: "aguardando-validacao",   label: "Aguardando validação",       bg: "#fdedc0", text: "#8a5a00" },
  { id: "aguardando-contrato",    label: "Aguardando contrato",        bg: "#fdedc0", text: "#8a5a00" },
  { id: "validado",               label: "Validado",                   bg: "#dbe9fe", text: "#1656c4" },
  { id: "envio-grafica",          label: "Envio gráfica",              bg: "#e2e4ff", text: "#3f3ad0" },
  { id: "envio-assessor",         label: "Envio assessor",             bg: "#c3f5d4", text: "#00814a" },
  { id: "reprovado",              label: "Reprovado",                  bg: "#ffdcdc", text: "#c62828" },
];
